...
!            x2 = tpl
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!modification beta coefficeint modification by priyanka and runing splitting
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!      enddo
      print* ,"at msusy scale",yy(9),yy(18),yy(27),yy(121),yy(120),
     $         yy(119),yy(126),yy(125),msusy
      print*,"before MSSM rge runing for itcount=1",x1,x2,msusy,
     $       tpl,tq0,MX
      call RK4ROUTINE(yy,n0,x1,x2,eps,h1,hmin,nok,nbad,mssmrge,QMSRK4,
     $     check)
!      print*,"before MSSM runing for itcount=1 from msusy to planck"
      if(check.eq.100)then
         flags = 'variable underflow '
      print*,"before MSSM runing for itcount=1 from msusy to planck"
         return
...
!     $     QMSRK4,check)
      ...
      do i=1,27
      print*,"yukawa input MSSM",yy(i)
      enddo

      Print*, "msusyint",n0,x1,x2,eps,h1,hmin,yy(111),yy(112),yy(119),
     $       yy(120),yy(121),yy(125),yy(126)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!modification ended for up runing
...
!!!!!GMSB!!!!!!!!!!!!!!!!!!!!!!!!!!end priyanka
!!!!!!!modification for our case for down runing by priyanka!!!
